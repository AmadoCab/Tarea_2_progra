...
\draw[-Latex] ($(q0)+(30:0.5)$) to[bend left] node[auto]{$\texttt{b}$} ($(q1)+(150:0.5)$);
...
\draw[-Latex] ($(q1)+(-60:0.5)$) arc[x radius=0.25,y radius=0.5,start angle=15,end angle=-195] node[midway,auto]{$\texttt{b}$};
\end{tikzpicture}
\end{center}